...
public class CommandHelp {
	...
	private void split(){
		...
		showSort.add("List of Command Keywords in TankTask:"
				...
				+ "		\n			Example: search fish"
				+ "\n"
				+ "		\n	show (Alternate form: showT, showE, showF, showO)"
				+ "		\n		Format 1: show [Task Type (Todo/Event/Floating/Overdue)]"
				+ "		\n			Example: show event"
				+ "	\n"
				+ "		\n		Format 2: show[X]"
				+ "		\n			Example: showE"
		...
		everyExit.add("List of Command Keywords in TankTask:"
				...
				+ "		\n			Example: every day 3pm"
				+ "		\n			Example: every week fri 11am"
				+ "		\n			Example: every month 15th"
				+ "		\n			Example: every year Apr 1"
				+ "\n"
				+ "		\n	reset"
		...
		desCate.add("List of Command Keywords in TankTask:"
				...
				+ "\n"
				+ "		\n	category (Alternate form: cat)"
				+ "		\n		Format: [Task Index] cat [Category Name]"
				+ "		\n			Example: 1 cat Hobbies");
