...
public class StorageTest {
	...
	/* ======================== CS2102 Tasks ========================= */
	private static final Task CATEGORY1_Task1 = 
			new Task("CS2102", "Read up on PHP", "Find out how to code query in PHP", 
	...
	private static final Task CATEGORY1_Task2 = 
			new Task("CS2102", "Revise SQL queries", "Read up on ALL SQL queries including nested", 
	...
	/* ======================== CS2103 Tasks ========================= */
	private static final Task CATEGORY2_Task1 = 
			new Task("CS2103", "Text Buddy CE2", "Change code to OOP style", 
	...
	private static final Task CATEGORY2_FLOAT1 = 
			new Task("CS2103", "Watch webcast", "Watch before November", -1, 
					"Tue, 20 Oct 8:00am", Storage.stringToMillisecond("Tue, 20 Oct 8:00am"), false);

	/* ======================== Personal Tasks ========================= */
	private static final Task CATEGORY3_Task1 = 
			new Task("Personal", "Help mum buy groceries", "Every Saturday!", "", -1, 3, "", -1, false);
	private static final Task CATEGORY3_FLOAT1 = 
			new Task("Personal", "Cut hair someday", "Cut before December", -1, 
					"Wed, 10 Oct 10:00am", Storage.stringToMillisecond("Wed, 10 Oct 10:00am"), false);
	private static final Task CATEGORY3_EVENT1 = 
			new Task("Personal", "Cycling @ East Coast", "Meet at bike rental at 3pm", 
	...
	private static final Task CATEGORY3_EVENT2 =
			new Task("Personal", "3D'09 gathering @ Mr Teo's house", "Meet at bike rental at 3pm", 
